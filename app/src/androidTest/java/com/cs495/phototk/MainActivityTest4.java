...
public class MainActivityTest4 {
    ...
    Instrumentation.ActivityMonitor monitor_exif = getInstrumentation().addMonitor(CalculatorActivity.class.getName(),null,false);
    ...
    {
        assertNotNull(mActivity.findViewById(R.id.home_calculator));
        onView(withId(R.id.home_calculator)).perform(click());
