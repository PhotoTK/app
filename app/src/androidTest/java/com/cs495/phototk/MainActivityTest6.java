...
public class MainActivityTest6 {
    ...
    Instrumentation.ActivityMonitor monitor_exif = getInstrumentation().addMonitor(MapsActivity.class.getName(),null,false);
    ...
    {
        assertNotNull(mActivity.findViewById(R.id.home_map));
        onView(withId(R.id.home_map)).perform(click());
