...
public class MainActivityTest3 {
    ...
    Instrumentation.ActivityMonitor monitor_exif = getInstrumentation().addMonitor(UserActivity.class.getName(),null,false);
    ...
    {
        assertNotNull(mActivity.findViewById(R.id.home_user));
        onView(withId(R.id.home_user)).perform(click());
